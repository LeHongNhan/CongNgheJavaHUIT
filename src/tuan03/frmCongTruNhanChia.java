...
public class frmCongTruNhanChia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        radCong.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                radCongActionPerformed(evt);
            }
        });

        radNhan.setText("Nhân");
        radNhan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                radNhanActionPerformed(evt);
            }
        });
    ...
    private void btnGiaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGiaiActionPerformed
        ...
        if (radCong.isSelected()) {
            ...
            if (b == 0) {
                txtKetQua.setText("B phai khac 0");
            }
            txtKetQua.setText(a / b + "");
    ...
    private void radCongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radCongActionPerformed
        if (radCong.isSelected()) {
            deselectedRad(radTru, radNhan, radChia);
        }        // TODO add your handling code here:
    }//GEN-LAST:event_radCongActionPerformed

    private void radNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radNhanActionPerformed
        if (radNhan.isSelected()) {
            deselectedRad(radCong, radTru, radChia);
        }         // TODO add your handling code here:
    }//GEN-LAST:event_radNhanActionPerformed
    ...
    private void radChiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radChiaActionPerformed
        if (radChia.isSelected()) {
            deselectedRad(radCong, radTru, radNhan);
        }     // TODO add your handling code here:
    ...
    private void radTruActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radTruActionPerformed
        if (radTru.isSelected()) {
            deselectedRad(radCong, radNhan, radChia);
        }
        // TODO add your handling code here:
